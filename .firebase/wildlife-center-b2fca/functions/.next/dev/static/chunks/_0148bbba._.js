...
function SubscriberPage() {
    ...
    if ($[0] !== "bdcf1137e9bfc0384e8fa3c2eb8905a85552540f4f0635d64b3d21fcaa19105c") {
        for(let $i = 0; $i < 18; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "bdcf1137e9bfc0384e8fa3c2eb8905a85552540f4f0635d64b3d21fcaa19105c";
    }
    ...
    let t1;
    if ($[2] !== user?.displayName) {
        t1 = user?.displayName?.split(" ")[0] || "Member";
        $[2] = user?.displayName;
        $[3] = t1;
    } else {
        t1 = $[3];
...
_s(SubscriberPage, "ut/QZQ+sRLHAeUdaelbxCMJXtxo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=_0148bbba._.js.map